...
**NOTE:**  Best use suggestion is to browse memes (hence the name) but it works for any/all images. 
...
All the python dependencies for the project are listed in the ```requirements.txt```.
